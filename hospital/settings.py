...
SECRET_KEY = 'django-insecure-mv2o=wcc9m($l5li1)9r@j!evtxq7=o0%65#5oq9vp**o(!gnz'
...
# Optional: Define which finder classes Django should use to locate static files
STATICFILES_FINDERS = [
    'django.contrib.staticfiles.finders.FileSystemFinder',
    'django.contrib.staticfiles.finders.AppDirectoriesFinder',  # Fixed typo here
]
